/* ============================================================
   ...
   - 100 m MOSFET ON / 180 m MOSFET OFF thresholds (bench-test)
   ------------------------------------------------------------
...
// ==================== TELEMETRY BUFFER ====================
#define TELEMETRY_BUFFER 200  // increased from 120 for future expansion
...
void loop() {
  ...
  char sentence[TELEMETRY_BUFFER];
  ...
  char fullSentence[TELEMETRY_BUFFER];
